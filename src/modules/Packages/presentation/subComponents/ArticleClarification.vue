...
import type ArticleClarificationModel from '../../core/models/subModels/Article.clarification.model';
import ArticleDocumentModel from '../../core/models/subModels/Article.document.model';

const { ClarificationData, isclarification } = defineProps<{
  ClarificationData: ArticleClarificationModel;
