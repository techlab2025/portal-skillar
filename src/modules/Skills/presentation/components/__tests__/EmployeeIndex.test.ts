...
vi.mock('../subComponents/DeleteSkillsDialog.vue', () => ({
  default: {
    name: 'DeleteSkillsDialog',
    template: '<span />',
    props: ['message'],
    emits: ['delete'],
  },
...
describe('SkillsIndex.vue', () => {
  ...
  it('renders correctly', () => {
    const wrapper = mount(SkillsIndex, { global: globalConfig });
  ...
  it('contains the "Add Skills" button', () => {
    const wrapper = mount(SkillsIndex, { global: globalConfig });
